    ...
    */
    ...
    function test_f6m_mul_loop() {
            ...
            */
            ...
            f6m_mul(point1_a, point2_A, f6m_result4, bls12_mod, inv, f6m_scratch_spaace)
            f6m_mul(point1_a, f6m_result4, f6m_result5, bls12_mod, inv, f6m_scratch_spaace)

            let i := 0
            for {} lt(i, 135) {i := add(i, 1)} {
                f6m_mul(f6m_result4, f6m_result5, f6m_result1, bls12_mod, inv, f6m_scratch_spaace)
                f6m_mul(f6m_result5, f6m_result1, f6m_result2, bls12_mod, inv, f6m_scratch_spaace)
                f6m_mul(f6m_result1, f6m_result2, f6m_result3, bls12_mod, inv, f6m_scratch_spaace)
                f6m_mul(f6m_result2, f6m_result3, f6m_result4, bls12_mod, inv, f6m_scratch_spaace)
                f6m_mul(f6m_result3, f6m_result4, f6m_result5, bls12_mod, inv, f6m_scratch_spaace)
